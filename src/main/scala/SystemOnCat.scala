...
class SystemOnCat extends Module {
    ...
    val cache_arbiter = Module(new CacheArbiter)
    cache_arbiter.io.cache1_response := core0.io.cache_response
    cache_arbiter.io.cache2_response := core1.io.cache_response
    core0.io.cache_turn := cache_arbiter.io.cache1_turn
    core1.io.cache_turn := cache_arbiter.io.cache2_turn
